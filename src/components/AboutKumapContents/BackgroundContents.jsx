	...
	return (
		<BackgroundContainer>
			<CircleStyle
				...
				zIndex={2}
			/>
			<CircleStyle color={'rgba(237, 248, 241, 0.7)'} size={'16rem'} top={'18rem'} left={'12%'} time={'6'} zIndex={1} />
			<CircleStyle color={'rgba(214, 239, 224, 0.6)'} size={'10rem'} top={'15rem'} left={'23%'} time={'5'} zIndex={1} />
